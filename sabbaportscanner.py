...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 4:
        print (' _____                   _                                                          ')
        print ('|  __ \                 | |                                                         ')  
        print ('| |__) |   ___    _ __  | |_     ___    ___    __ _   _ __    _ __     ___   _ __   ')
        print ('|  ___/   / _ \  | __| | __|    / __|  / __|  / _` | |  _ \  |  _ \   / _ \ |  __|  ')
        print ('| |      | (_) | | |    | |_    \__ \ | (__  | (_| | | | | | | | | | |  __/ | |     ')
        print ('|_|       \___/  |_|     \__|   |___/  \___|  \__,_| |_| |_| |_| |_|  \___| |_|     ')

        
        print('Usage:   python3 sabbaportscanner.py <IP address> <start port> <end port>')
        print('Example: python3 sabbaportscanner.py 192.168.1.10 1 65535\n')
        print('Usage:   python3 sabbaportscanner.py <network> <start port> <end port> -n')
        print('Example: python3 sabbaportscanner.py 192.168.1 1 65535 -n')
